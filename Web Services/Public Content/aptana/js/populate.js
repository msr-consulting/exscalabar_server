function pop_nav(loc){ 
	...
	document.getElementById("xnav").innerHTML ='<nav class="navbar navbar-default navbar-fixed-top">\
						...
						<ul class="nav bs-docs-sidenav">\
							...
							<li class>\
								<div class="panel panel-default">\
								  <div id = "time" class="panel-body"> \
								    \
								  </div>\
								</div>\
							</li>\
							<li class>\
								<button id ="reconnect" class="btn btn-default">\
									Attempt Reconnect\
								</button>\
							</li>\
						</ul>\
